...
echo [Product Drill] Opening formal MVP - Module11 history search filter test...

if not exist "%APP_DIR%\package.json" (
  echo [ERROR] Formal MVP app folder was not found.
  echo %APP_DIR%
  pause
  exit /b 1
)
...
if errorlevel 1 (
  echo [ERROR] npm.cmd was not found. Please install Node.js / npm first.
  pause
  exit /b 1
)
